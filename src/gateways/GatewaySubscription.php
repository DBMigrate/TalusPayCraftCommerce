...
class GatewaySubscription extends \craft\commerce\base\SubscriptionGateway
{
    ...
    {
        return Craft::t('commerce', 'Talus Pay subscription');
    }
    ...
    {
        return Craft::$app->getView()->renderTemplate('commerce-paytrace/Subscriptions/planSettings', $params);
    }
    ...
    public function subscribe(
        User $user,
        BasePlan $plan,
        BaseSubscriptionForm $parameters
